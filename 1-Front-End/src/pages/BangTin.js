...
import { faUser, faCog, faBell, faTimes, faBars, faSignOut, faPalette, faNewspaper } from '@fortawesome/free-solid-svg-icons'
...
//import TabBangTin from "../components/Tabs/TabBangTin";
import TabChuDe from "../components/Tabs/TabChuDe";
import TabDangTin from "../components/Tabs/TabDangTin";
import '../App.css';
...
function BangTin() {
    ...
    if (activeTab === tabs.tab1) {
        TabComponent = TabChuDe;
    }

    if (activeTab === tabs.tab2) {
        TabComponent = TabDangTin;
    }
                ...
                <div className="row">
                    ...
                    <div className={contentColumnClass} style={{
                        ...
                        <div style={{ marginLeft: '2%', marginRight: '1%' }}>
                            <div style={{ marginLeft: '0px' }} className="row">
                                <ul class="nav nav-tabs col-6" >
                                    ...
                                    {/* {canViewContract ?
                                        ...
                                        <li class="nav-item">
                                            <button
                                                className={activeTab === 'TabBangTin' ? 'nav-link active' : 'nav-link'}
                                                style={{ color: 'blue' }}
                                    ...
                                    <li class="nav-item">
                                        <button
                                            className={activeTab === 'TabDangTin' ? 'nav-link active' : 'nav-link'}
                                            style={{ color: 'blue' }}
                                    ...
                                    <li class="nav-item">
                                        <button
                                            className={activeTab === 'TabChuDe' ? 'nav-link active' : 'nav-link'}
                                            style={{ color: 'blue' }}
                            ...
                            <TabComponent isMobile={isMobile} MaThanhVien={thongTinDangNhap.ThanhVien.MaThanhVien} />
