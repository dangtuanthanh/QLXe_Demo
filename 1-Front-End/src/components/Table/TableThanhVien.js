                    ...
                    props.duLieuHienThi.map((dulieu, index) =>
                        ...
                        <tr style={{ 'textAlign': 'center' }} id='trdata' key={dulieu.MaThanhVien} onClick={() => {
                            ...
                            <td style={{ textAlign: 'left' }}>
                                {
                                    dulieu.TenThanhVien ?
                                        dulieu.TenThanhVien.length > 20 ?
                                            dulieu.TenThanhVien.slice(0, 20) + '...' :
                                            dulieu.TenThanhVien
                                        : ''
                                }
                            </td>
                            <td style={{ textAlign: 'left' }}>
                                {
                                    dulieu.DiaChi ?
                                        dulieu.DiaChi.length > 35 ?
                                            dulieu.DiaChi.slice(0, 35) + '...' :
                                            dulieu.DiaChi
                                        : ''
                                }
                            </td>
                            ...
                            <td>
                                {
                                    dulieu.SoDienThoai ?
                                        dulieu.SoDienThoai.length > 12 ?
                                            dulieu.SoDienThoai.slice(0, 12) + '...' :
                                            dulieu.SoDienThoai
                                        : ''
                                }
                            </td>
