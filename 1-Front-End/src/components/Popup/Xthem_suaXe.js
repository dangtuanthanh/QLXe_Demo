...
import { faSearchPlus, faAngleDown } from '@fortawesome/free-solid-svg-icons'
import SearchComBoBox from "../SearchCombobox";
import { urlViewMyCar } from "../url"
import Them_suaLoaiXe from "./them_suaLoaiXe";
import Them_suaTinhTrangXe from "./them_suaTinhTrangXe";
import Them_suaDangKiem from "./Xthem_suaDangKiem";
import Them_suaBaoHiem from "./Xthem_suaBaoHiem";
import Them_suaPhuHieu from "./Xthem_suaPhuHieu";
import Them_suaDinhVi from "./Xthem_suaDinhVi";
import Them_suaBaoDuong from "./Xthem_suaBaoDuong";
import Them_suaLichSuSuDung from "./Xthem_suaLichSuSuDung";
//import Them_suaHopDong from "./them_suaHopDong";

const Xthem_suaXe = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.iDAction) {
            const fetchGetTable = fetch(`${urlViewMyCar}?id=${props.iDAction}`, {
                method: 'GET',
                headers: {
                    'mahopdong':props.maHopDong,
                ...
                <div className="conten-modal">
                    <div>
                        ...
                        >
                            ...
                            <div>
                                <button style={{ marginBottom: '0px' }} onClick={() => { props.setPopupInsertUpdate(false) }} type="button" className="btn btn-danger mt-3" >Đóng</button>
                                {/* <button
