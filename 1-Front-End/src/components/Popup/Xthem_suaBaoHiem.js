...
import { urlViewMyInsurance } from "../url"

const Xthem_suaBaoHiem = (props) => {
    //xử lý redux
    ...
    useEffect(() => {
        ...
        if (props.iDAction) {
            const fetchGetAccount = fetch(`${urlViewMyInsurance}?id=${props.iDAction}&id2=${props.iDAction2}`, {
                method: 'GET',
                headers: {
...
export default Xthem_suaBaoHiem;