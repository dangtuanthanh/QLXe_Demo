...
import { urlViewMyRegistry } from "../url"

const Xthem_suaDangKiem = (props) => {
    //xử lý redux
    ...
    console.log('props.iDAction', props.iDAction);
    useEffect(() => {
        dispatch({ type: 'SET_LOADING', payload: true })
        if (props.iDAction) {
            const fetchGetAccount = fetch(`${urlViewMyRegistry}?id=${props.iDAction}&id2=${props.iDAction2}`, {
                method: 'GET',
                headers: {
...
export default Xthem_suaDangKiem;